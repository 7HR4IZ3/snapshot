...
function usage(): string {
  return [
    ...
    "  snapshot spawn <workspace-path> [--project <path>] [--agent <id>] [--label <name>] [--from <ref>] [--backend auto|worktree|apfs-cow|overlay] [--strict-backend] [--include <csv-globs>] [--exclude <csv-globs>] [--symlink <csv-globs>] [--symlink-mode shared-live|safety-restricted]",
